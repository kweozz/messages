...
// GET /api/v1/messages - Alle berichten of berichten van een specifieke gebruiker ophalen
app.get('/api/v1/messages', (req, res) => {
  const user = req.query.user;
  
  // Als een gebruiker is opgegeven, filter de berichten
  if (user) {
    ...
    // Anders geef je alle berichten terug
    res.json({
      status: "success",
      message: "Messages fetched successfully",
      data: { messages }
